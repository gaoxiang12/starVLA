#!/bin/bash
# Train LeWM-OFT on patchified TAESD feature maps. TAESD outputs a 4x32x32
# latent at 256px; each 8x8x4 block becomes one of 16 tokens per camera view.

set -e

Framework_name=LeWMOFT
base_wm=${BASE_WM:-madebyollin/taesd}
...
run_id=${RUN_ID:-lewm_oft_libero_taesd_spatial4x4_delta_dim384_100k}
batch=${BATCH:-8}
steps=${STEPS:-100000}
