#!/usr/bin/env bash
# Fine-tune only the LIBERO latent world model beyond its ~0.5 MSE plateau.
set -euo pipefail
...
CONFIG="${CONFIG:-examples/LIBERO/train_files/starvla_lewm_oft_dinov3_libero_wm_only_ctx2_state_cosine.yaml}"
RUN_ID="${RUN_ID:-lewm_oft_libero_dinov3b_wmonly_ctx2_state8_cos01_from220k_50k}"
